        ...
        <div class="bulk-actions-bar" id="bulkActionsBar" style="display: none;">
            <div class="bulk-left">
                <label class="checkbox-wrapper">
                    ...
                    <span class="checkbox-label">Seleccionar todos en pantalla</span>
                </label>
                <span id="selectedCount" class="selected-count">0 seleccionados</span>
            </div>
            <div class="bulk-right">
                <select id="bulkAction" class="select">
                ...
                <button id="applyBulkAction" class="btn btn-primary" disabled>Aplicar</button>
            </div>
        </div>
        ...
        <div class="table-wrap">
            <table class="users">
                <thead class="sticky">
                    <tr>
                        <th style="width:50px;">
                            <input type="checkbox" id="headerCheckbox" style="cursor:pointer;" />
                        </th>
                        ...
                        <th style="width:140px;">Última sesión</th>
