<?php
/**
 * Módulo: Usuarios Nunca Logueados - Listado
 */
...
<head>
    ...
    <title>Usuarios Nunca Logueados - Telegan Admin</title>
...
<body>
    ...
    <main class="main-content">
        <div class="content-header">
            <h1 class="page-title">Usuarios Nunca Logueados</h1>
            <p class="page-subtitle">Listado de usuarios activos que nunca han iniciado sesión</p>
        </div>
    ...
    <script type="module">
        ...
        function buildUrl() {
            ...
            return `api/alerts-users-never-logged-in.php?${params.toString()}`;
        }
