<?php
/**
 * API: Usuarios nunca logueados - Listado completo
 */
...
try {
    ...
    // Usuarios nunca logueados (ultima_sesion IS NULL)
    $sql = "
        SELECT 
    ...
    error_log('alerts-users-never-logged-in.php error: ' . $e->getMessage());
