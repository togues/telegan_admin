<?php
/**
 * API: Cambiar estado activo de índice satelital
 */
...
try {
    ...
    $updated = Database::update(
        'UPDATE indice_satelital SET activo = CAST(:activo AS BOOLEAN) WHERE codigo = :codigo',
        [
    ...
    error_log('Error PDO en indices-toggle.php: ' . $e->getMessage());
    respond([
        'success' => false,
        'error'   => 'Error de base de datos: ' . $e->getMessage()
    ], 500);
} catch (Throwable $e) {
    error_log('Error en indices-toggle.php: ' . $e->getMessage());
    respond([
        'success' => false,
