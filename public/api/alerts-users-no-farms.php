<?php
/**
 * API: Usuarios sin fincas - Listado completo
 */
...
try {
    ...
    $where = [
        'u.activo = TRUE',
        'NOT EXISTS (SELECT 1 FROM usuario_finca uf WHERE uf.id_usuario = u.id_usuario)'
    ];
    $params = [];
    ...
    error_log('alerts-users-no-farms.php error: ' . $e->getMessage());
